...
let
  nvccCompatibilities = {
    ...
    "11.2" = nvccCompatibilities."11.1" // {
      clangMaxMajorVersion = "11";
    };

    # No changes from 11.2 to 11.3
    "11.3" = nvccCompatibilities."11.2";
    ...
    "12.2" = nvccCompatibilities."12.1" // {
      clangMaxMajorVersion = "16";
    };

    # No changes from 12.2 to 12.3
    "12.3" = nvccCompatibilities."12.2";
  };
in
nvccCompatibilities
